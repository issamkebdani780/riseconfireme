            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-3xl mx-auto text-center mb-16 lg:mb-24 space-y-4">
                    <h2 className="text-3xl lg:text-5xl font-extrabold text-heading dark:text-white leading-tight animate-slide-up">
                        ...
                        <span className="text-primary tracking-tight">{t('ventes confirmées.')}</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch max-w-7xl mx-auto">
                    ...
                    <div className="group relative bg-white dark:bg-slate-900/50 rounded-[40px] p-8 lg:p-14 border border-slate-100 dark:border-slate-800 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                        ...
                        <div className="space-y-6">
                            <ProblemItem
                                ...
                                title={t("Appels manqués et retardés")}
                                description={t("Les clients changent d'avis si vous tardez trop.")}
                                isNegative
                            />
                            <ProblemItem
                                ...
                                title={t("Fausse commandes non détectées")}
                                description={t("Vous payez la livraison pour rien.")}
                                isNegative
                            />
                            <ProblemItem
                                ...
                                title={t("Taux de retour élevé")}
                                description={t("Le manque de suivi direct coûte cher.")}
                                isNegative
                            />
                            <ProblemItem
                                ...
                                title={t("Aucun Upsell")}
                                description={t("Occasions manquées d'augmenter le panier.")}
                                isNegative
                            />
                        </div>
                    </div>
                    ...
                    <div className="group relative bg-white dark:bg-slate-900 rounded-[40px] p-8 lg:p-14 border border-blue-50 dark:border-blue-900/30 animate-slide-up shadow-premium" style={{ animationDelay: '0.3s' }}>
                        ...
                        {/* Stats Floating Card */}
                        <div className="mb-10 xl:mb-0 xl:absolute xl:top-[35%] xl:-right-16 rtl:xl:right-auto rtl:xl:-left-16 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-5 rounded-[24px] shadow-xl border border-slate-100 dark:border-slate-700 animate-float z-20 min-w-[240px]">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-[10px] font-black text-slate-400 uppercase">{t('Impact Direct')}</div>
                                    <div className="text-sm font-bold text-heading dark:text-white">{t('Réduction des retours de')} <span className="text-green-600">25%</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <ProblemItem
                                ...
                                title={t("Agents experts en 5 min")}
                                description={t("Confirmation immédiate dès que la commande arrive.")}
                            />
                            <ProblemItem
                                icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>}
                                title={t("Filtrage anti-fake")}
                                description={t("Économisez vos frais de livraison inutiles.")}
                            />
                            <ProblemItem
                                icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>}
                                title={t("Upsell systématique")}
                                description={t("Augmentez votre chiffre d'affaires gratuitement.")}
                            />
                            <ProblemItem
                                icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>}
                                title={t("Reporting temps réel")}
                                description={t("Suivi chaque appel et chaque centime.")}
                            />
                        </div>
                    </div>
