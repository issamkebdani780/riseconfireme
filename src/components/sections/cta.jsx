...
const FinalCTA = () => {
    const reassurances = [
        { label: "Mise en route immédiate", icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg> },
        { label: "Agents certifiés COD", icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg> },
        { label: "Support local 7j/7", icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg> },
        { label: "Essai sans engagement", icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.585 15.585a6.219 6.219 0 001.246-1.334L12 9l-4.831 5.251a6.219 6.219 0 001.246 1.334M12 9v12m0-12L7.169 14.251M12 9l4.831 5.251" /></svg> }
    ];
                    ...
                    <div className="relative w-full h-full bg-gradient-to-br from-blue-50/50 to-white dark:from-slate-900 dark:to-slate-950 rounded-[44px] p-10 lg:p-24 flex flex-col items-center text-center space-y-12 border border-slate-100 dark:border-slate-800 transition-colors duration-500">
                        ...
                        <div className="max-w-3xl space-y-4">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 dark:text-white leading-tight">
                                Transformez vos commandes en <br />
                                <span className="text-primary italic">ventes réelles.</span>
                            </h2>
                            <p className="text-sm lg:text-base text-slate-500 dark:text-slate-400 font-medium max-w-xl mx-auto">
                                Rejoignez les centaines de boutiques qui ont délégué leur confirmation à RiseConfirm et voient leur taux de livraison s'envoler.
                            </p>
                        </div>
